...
export const CUSTOMER_REVIEWS: CustomerReview[] = [
  {
    ...
    rating: 5,
    date: '2 days ago',
    title: 'Incredible Gucci GG Supreme Finish & Fast PostEx COD!',
    comment: 'Ordered the Gucci GG Supreme Web Stripe Bifold. Received it via PostEx Cash on Delivery in 2 days in Lahore. The GG monogram canvas and interior calfskin quality are world-class!',
  ...
  },
  {
    ...
    comment: 'I bought the Gucci Marmont Zip-Around Wallet for my wife and the Neo Classic Long Organizer for myself. Paid Cash on Delivery in Karachi via PostEx. The magnetic gift boxes and authenticity certificate cards feel like Rs. 100,000+ designer boutique packaging!',
  ...
  },
  {
    ...
    comment: 'Most imported wallets are too small for 5000 Rupee notes. The Sovereign Italian Bifold is tailored perfectly with extra currency depth. Delivered quickly via PostEx!',
  ...
  {
    id: 'rev-9',
    author: 'Mian Hassan Sharif',
    city: 'Gujranwala',
    rating: 5,
    date: '1 month ago',
    title: 'Crazy Horse leather develops amazing patina!',
    comment: 'The Artisan Crazy Horse Bifold smells like authentic full-grain raw leather. After 2 weeks of daily pocket carry, it has acquired a rich dark shine. 100% recommended!',
    productName: 'The Artisan Crazy Horse Bifold',
    productId: 'artisan-raw-bifold',
    verifiedPurchase: true
  },
  {
    id: 'rev-10',
    ...
    rating: 5,
    date: '1 month ago',
    title: 'Super slim executive cardholder',
    comment: 'Minimalist carry at its best. Holds 6 cards and cash notes without bulging in my dress pants. Delivered in Quetta within 3 days via PostEx COD.',
    productName: 'The Executive Slim Cardholder',
    productId: 'executive-slim-cardholder',
    verifiedPurchase: true
  },
  {
    id: 'rev-11',
    ...
    rating: 5,
    date: '1 month ago',
    title: 'Dual Currency Divider for PKR and USD',
    comment: 'I travel frequently for business. The dual cash compartment in the Sovereign Italian Bifold keeps PKR 5000 notes separated from US Dollars cleanly.',
    productName: 'The Sovereign Italian Bifold',
    productId: 'sovereign-bifold',
    verifiedPurchase: true
  },
  {
    id: 'rev-12',
    author: 'Waqas Rasheed',
    city: 'Sargodha',
    rating: 5,
    date: '1 month ago',
    title: 'RFID Blocking protection tested with NFC scanner',
    comment: 'Tested my contactless HBL card inside the Obsidian Vault with an NFC app on my phone. Completely blocked! Absolute peace of mind.',
    productName: 'The Obsidian Pop-Up RFID Vault',
    productId: 'obsidian-smart-cardholder',
    verifiedPurchase: true
  }
